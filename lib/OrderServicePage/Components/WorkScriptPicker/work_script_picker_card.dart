...
class WorkScriptPickerCard extends StatefulWidget {
  final String? id;
  ...
  @override
  State<WorkScriptPickerCard> createState() => _WorkScriptPickerCardState();
}

class _WorkScriptPickerCardState extends State<WorkScriptPickerCard> {
  String? id;
  String? bindingCount;
  String? name;
  String? desc;
